            ...
            MCPTool(
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "mesh_probe": {"type": "boolean"},
                        "mesh_probe_marketplace": {"type": "boolean"},
        ...
        if tool_name == "novaadapt_swarm_run":
            ...
            for idx, objective in enumerate(selected, start=1):
                run_payload = {
                    ...
                    "mesh_probe": bool(arguments.get("mesh_probe", False)),
                    "mesh_probe_marketplace": bool(arguments.get("mesh_probe_marketplace", False)),
