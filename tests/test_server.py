    ...
    def test_http_endpoints(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertIn("/voice/status", openapi["paths"])
                self.assertIn("/voice/transcribe", openapi["paths"])
                self.assertIn("/voice/synthesize", openapi["paths"])
                self.assertIn("/canvas/status", openapi["paths"])
                self.assertIn("/canvas/render", openapi["paths"])
                self.assertIn("/canvas/frames", openapi["paths"])
                self.assertIn("/workflows/status", openapi["paths"])
                self.assertIn("/workflows/list", openapi["paths"])
                self.assertIn("/workflows/item", openapi["paths"])
                self.assertIn("/workflows/start", openapi["paths"])
                self.assertIn("/workflows/advance", openapi["paths"])
                self.assertIn("/workflows/resume", openapi["paths"])
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with mock.patch.dict(
                ...
                try:
                    ...
                    self.assertIn("preset-export-btn", html_with_query)
                    self.assertIn("preset-import-btn", html_with_query)
                    self.assertIn("preset-import-file", html_with_query)
                    self.assertIn("preset-import-preview", html_with_query)
                    self.assertIn("preset-import-diff", html_with_query)
                    self.assertIn("safety-profile", html_with_query)
                    self.assertIn("safety-profile-apply-btn", html_with_query)
                    ...
                    self.assertIn("safety-summary-copy-btn", html_with_query)
                    self.assertIn("safety-summary-include-ts", html_with_query)
                    self.assertIn("safety-copy-live", html_with_query)
                    self.assertIn("aria-live=\"polite\"", html_with_query)
                    ...
                    self.assertIn("template-policy-hint", html_with_query)
                    self.assertIn("Template: Aetherion Monitor", html_with_query)
                    self.assertIn("Safety Lock Profile", html_with_query)
                    self.assertIn("Active Safety Posture", html_with_query)
                    self.assertIn("strict", html_with_query)
                    self.assertIn("balanced", html_with_query)
                    self.assertIn("lab", html_with_query)
                    self.assertIn("custom", html_with_query)
                    ...
                    self.assertIn("copySafetySummary", html_with_query)
                    self.assertIn("buildCopySafetySummary", html_with_query)
                    self.assertIn("fallbackCopyText", html_with_query)
                    self.assertIn("handleCopyShortcut", html_with_query)
                    self.assertIn("shortcutInEditableTarget", html_with_query)
                    self.assertIn("window.addEventListener('keydown', handleCopyShortcut)", html_with_query)
                    self.assertIn("flashCopiedButtonState", html_with_query)
                    self.assertIn("announceCopyStatus", html_with_query)
                    self.assertIn("button.compact.copied", html_with_query)
                    self.assertIn("Copied", html_with_query)
                    self.assertIn("Safety posture=", html_with_query)
                    self.assertIn("copied_at_utc=", html_with_query)
                    self.assertIn("Ctrl/Cmd+Shift+C", html_with_query)
                    ...
                    self.assertIn("Apply Profile", html_with_query)
                    self.assertIn("Copy safety summary", html_with_query)
                    self.assertIn("Include UTC timestamp", html_with_query)
                    self.assertIn("Safety summary copied to clipboard", html_with_query)
                    self.assertIn("Safety summary copy failed: clipboard unavailable", html_with_query)
                    self.assertIn("Reset Operator Preferences", html_with_query)
                    self.assertIn("Preview dry-run diff before replacing existing preset names", html_with_query)
                    self.assertIn("Policy hint (Aetherion Monitor)", html_with_query)
