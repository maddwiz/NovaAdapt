...
- Canvas/workflow inspector UI now includes operator safety/persistence tooling:
  ...
  - coverage assertions updated in `tests/test_server.py` for preset/safety/export/import/diff-preview/profile/posture/legend/custom-sync/risk-banner/prompt-summary/inline-summary/copy/timestamp/flash/localStorage controls in rendered HTML
...
2. Add an optional keyboard shortcut (`Ctrl/Cmd+Shift+C`) to copy the inline safety summary.
